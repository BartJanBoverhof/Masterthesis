...
Original file is located at
    https://colab.research.google.com/drive/1PsSXXPvB7VRytEYDM9fEsZRcL4kDgRPu
"""
...
if __name__ == "__main__":
    for participant in participants:
        ...
        with open("/content/drive/MyDrive/thesis/models/multi_"+participant+".pickle", 'wb') as handle: #Save as pickle
