...
| `pipeline` | Folder that contains scripts to read data and cut into epochs of `pytorch tensor` type. | ![Python version](https://img.shields.io/badge/Python-%33.9-yellow) |
